...
// listen to a port and display it to console
app.listen(port, () => console.log(`Invoice app listening on port ${port}!`))
...
app.all('/invoice', function (req, res) {
  ...
  Fabric_Client.newDefaultKeyValueStore({
    ...
    // run functions if POST method
    if (req.method == "POST") {

      var username = req.body.username;

      // Don't alow other registered users to do the transaction
      if (username != "Samsung") {
